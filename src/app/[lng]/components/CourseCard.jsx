...
const CourseCard = ({ classNum, lng }) => {
  ...
  return (
    <div className={`card ${flip ? "flip" : ""} relative flex flex-col bg-gray h-48 w-full border-2 border-navy rounded-[32px] overflow-clip shadow-xl place-content-center`}>
{/* ------------------------- FRONTSIDE ------------------------- */}
